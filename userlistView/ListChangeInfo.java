...
public class ListChangeInfo {
    ...
    public static String selectedItem;//用户类型下拉框中选中的item
    public static int selectedItem1 = 0;//是否逻辑删除下拉框中选中的item1
    ...
    public void repetitive(){
        ...
        for (int i = 0; i < listData.length; i++) {
            if(listData[i].equals(JTableDefineTest.u.getUserType())){
                defaultItem = i;
                break;
            }
        }
        ...
        username_textfield.setText(JTableDefineTest.u.getUserName());
        ...
        pwd_textfield.setText(JTableDefineTest.u.getPassword());
        ...
        for (String s : listData1) {
            if (s.equals(listData1[JTableDefineTest.u.getIsdel()])) {
                selectedItem = s;
                break;
            }
        }
        ...
        //设置默认选中的条目
        comboBox1.setSelectedIndex(JTableDefineTest.u.getIsdel());
